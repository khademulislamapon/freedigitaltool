...
const Disclaimer = () => {
  return (
    <>
      <Helmet>
        <title>Disclaimer - Free Digital Tool</title>
      ...
      <div className="p-6 max-w-3xl mx-auto bg-white shadow-md mt-10">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Disclaimer) refers to Free Digital Tool.</li>
          <li><strong>Service</strong> refers to the Website.</li>
          <li><strong>You</strong> means the individual accessing the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
          <li><strong>Website</strong> refers to Free Digital Tool, accessible from <a href="http://freedigitaltool.com/" target="_blank" rel="external nofollow noopener" className="text-blue-500">http://freedigitaltool.com/</a></li>
        </ul>
